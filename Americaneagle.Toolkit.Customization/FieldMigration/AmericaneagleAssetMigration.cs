...
namespace Americaneagle.Toolkit.Customization.Extensions;

public class AmericaneagleAssetMigration(
    ILogger<AmericaneagleAssetMigration> logger,
    ...
    AmericaneagleAssetFacade assetFacade,
...
) : IFieldMigration
{
    ...
    public bool ShallMigrate(FieldMigrationContext context)
    {
        ...
        if (context.SourceObjectContext is DocumentSourceObjectContext)
        {
            DocumentSourceObjectContext sourceObjectContext = (DocumentSourceObjectContext)context.SourceObjectContext;
            var pageType = sourceObjectContext.NodeClass.ClassName;
        }
        
        return (
                   context.SourceDataType is KsFieldDataType.DocAttachments or KsFieldDataType.File ||
                   Kx13FormControls.UserControlForText.MediaSelectionControl.Equals(context.SourceFormControl,
                       StringComparison.InvariantCultureIgnoreCase) ||
                   Kx13FormControls.UserControlForText.DirectUploadControl.Equals(context.SourceFormControl,
                       StringComparison.InvariantCultureIgnoreCase)  
               ) &&
    ...
    public void MigrateFieldDefinition(FormDefinitionPatcher formDefinitionPatcher, XElement field, XAttribute? columnTypeAttr, string fieldDescriptor)
    {
        ...
        else
        {
            ...
            Guid[] allowedContentTypes = [new Guid("8f40b29a-7e3d-4110-a483-30248db4af85"), new Guid("02702ef4-8703-4b2d-85b0-89be94797bd1")];
